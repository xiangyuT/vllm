...
def _gemma_rms_norm_impl(
    ...
    # GemmaRMSNorm computes (x_normed_fp32 * (1 + weight.float())).to(dtype).
    # The raw weight is passed to the XPU kernel so the offset and multiply are
    # performed in the fused implementation.
